<template>
  <div class="step1-wrapper">
    <a-form-model ref="orderCreate" :model="form" :rules="rules" layout="vertical" :validate-messages="this.language!=='EN'?validateMessage:null">
      <a-row>
        <a-col :md="24" :lg="12">
          <a-form-model-item :label="msg.item1.label" prop="name">
            <a-input v-model="form.name" :max-length="16" :placeholder="msg.item1.placeholder" width />
          </a-form-model-item>
        </a-col>
        <a-col :md="24" :lg="12">
          <a-form-model-item :label="msg.item2.label" prop="mobile">
            <a-input v-model="form.mobile" :placeholder="msg.item2.placeholder" />
          </a-form-model-item>
        </a-col>
      </a-row>
      <a-row>
        <a-col :md="24" :lg="12">
          <a-form-model-item :label="msg.item4.label" prop="company">
            <a-input v-model="form.company" :placeholder="msg.item4.placeholder" />
          </a-form-model-item>
        </a-col>
        <a-col :md="24" :lg="12">
          <a-form-model-item :label="msg.item5.label" prop="title">
            <a-input v-model="form.title" :placeholder="msg.item5.placeholder" />
          </a-form-model-item>
        </a-col>
      </a-row>
      <a-row>
        <a-col :md="24" :lg="12">
          <a-form-model-item :label="msg.item6.label" prop="interviewer">
            <a-input v-model="form.interviewer" :placeholder="msg.item6.placeholder" />
          </a-form-model-item>
        </a-col>
        <a-col :md="24" :lg="12">
          <a-form-model-item :label="msg.item7.label" prop="purposeId">
            <a-select mode="single" allowClear v-model="form.purposeId" :placeholder="msg.item7.placeholder">
      ...
      <a-row>
        <a-col :md="24" :lg="12">
          <a-form-model-item :label="msg.item8.label" prop="visitAreaId">
            <a-select mode="single" allowClear v-model="form.visitAreaId" :placeholder="msg.item8.placeholder">
